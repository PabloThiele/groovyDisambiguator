...
def config = [
        ...
        "neostore.nodestore.db.mapped_memory": "350M",
        "neostore.relationshipstore.db.mapped_memory": "1G",
        "neostore.propertystore.db.mapped_memory": "600M",
        "neostore.propertystore.db.strings.mapped_memory": "600M",
            ...
            for (i = 0; i < words.size; i++) {
                ...
                if ((i - 1) >= 0) {
                    ...
                    if (!tags[previousWordTag.macMorphoTag]) {
                        batch.createNode([tag:previousWordTag.macMorphoTag], macMorphoTagArray)
                ...
                if (!tags[actualWordTag.macMorphoTag]) {
                    batch.createNode( [tag: actualWordTag.macMorphoTag], Labels.MacMorphoTag)
                ...
                if ((i + 1) < words.size) {
                    ...
                    if (!tags[nextWordTag.macMorphoTag]) {
                        batch.createNode( [tag: nextWordTag.macMorphoTag], Labels.MacMorphoTag)
                ...
                if (!palavras[actualWordTag.word]) {
                    batch.createNode( [word: actualWordTag.word], Labels.Palavra)
                ...
                if (!tagGroups[groupKey]) {
                    batch.createNode( [group: tagGroup], Labels.TagGroup)
